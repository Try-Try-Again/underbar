(function() {
  ...
  _.each = function(collection, iterator) {
    //var colKeys = Object.keys(collection);
  ...
  _.map = function(collection, iterator) {
    var result = [];
    _.each(collection, (element) => result.push(iterator(element)));
    return result;
  };
  ...
  _.memoize = function(func) {
    ...
    return function(){
      ...
      if (history[key]){
        ...
        history[key] = func.apply(this, arguments);
        return history[key];
      }
    }
  }
  ...
  _.shuffle = function(array) {
    ...
    while (elements.length > 0) {
      shuffled.push(elements.pop(Math.random() * elements.length));
    }
    return shuffled;
  };
